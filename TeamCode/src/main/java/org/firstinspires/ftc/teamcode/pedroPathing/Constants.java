...
public class Constants {
    ...
    public static FollowerConstants followerConstants = new FollowerConstants()
            ...
            .headingPIDFCoefficients(new PIDFCoefficients(0.65,0,0.1,0))
            .translationalPIDFCoefficients(new PIDFCoefficients(0.45, 0, 0.059, 0.01))
            .drivePIDFCoefficients(new FilteredPIDFCoefficients(0.017, 0, 0.001, 0, 0.01))
            .forwardZeroPowerAcceleration(-26.21)
            .lateralZeroPowerAcceleration(-55.98)
            //i like boys
    ...
    public static MecanumConstants driveConstants = new MecanumConstants()
            ...
            .xVelocity(82.64552415262057)
            .yVelocity(66.42505171167569)
